...
export class CustomRichTextEditor
  ...
  public loadWidget() {
    ...
    var fontSizes = "8pt 10pt 12pt 14pt 18pt 24pt 36pt";
    var isBrowserSpellCheckenabled = true;

    //Main method to load the RichText configurations
    this._tinymce.init({
      selector: "#text_editor" + this._domId,
      width: "100%",
      height: "100%",
      browser_spellcheck: true,
      plugins: pluginToBeIncluded,
